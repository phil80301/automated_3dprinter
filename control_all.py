...
def remove_print(remover, printer_index, printer):
    ...
    printer.write("M400") # Set bed temperature to 59 degrees celcius
...
def main(printers, remover):
    ...
    while not finished:
        ...
        if keyboard.is_pressed('ctrl+1'): # if key 'k' is pressed
            print('you pressed 1')
            interrupt([printers[0]], remover)
            continue

        if keyboard.is_pressed('ctrl+2'): # if key 'k' is pressed
            print('you pressed 2')
            interrupt([printers[1]], remover)
            continue

        if keyboard.is_pressed('ctrl+3'): # if key 'k' is pressed
            print('you pressed 3')
            interrupt([printers[2]], remover)
            continue

        if keyboard.is_pressed('ctrl+4'): # if key 'k' is pressed
            print('you pressed 4')
